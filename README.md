...
> **[https://huggingface.co/spaces/DannyingFace/cerebras-perf-dashboard](https://huggingface.co/spaces/DannyingFace/cerebras-perf-dashboard)**
...
### 2. Clone the repo
```bash
git clone https://github.com/sergioEl/ai-model-quality-challenge.git
